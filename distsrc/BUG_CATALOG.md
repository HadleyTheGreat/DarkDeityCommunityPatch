...
This is a list of all bug fixes and mods included in the patch.
...
BUG: Battlesaves do not store historical battle data for the chapter during saving or restore it upon reload.  This causes battle history at the end of the map to be wrong and items that get boosts from kills or crits done during the map to reset their effectiveness on loading from a battlesave.
...
BUG: Irving's hair reverts from black to red if loading from a normal save or a battlesave in chapters 12 to 16 (scenes 83 to 129).
...
* gml_GlobalScript_scr_load_game_8.gml
...
Translation issue (English): "King Varic has sent countless Delians to their lives".  "lives" should be "deaths".
* Chapnames.csv
